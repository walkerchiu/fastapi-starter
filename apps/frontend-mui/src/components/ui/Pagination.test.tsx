...
describe('Pagination', () => {
  ...
  it('renders page buttons for small page counts', () => {
    ...
    // MUI Pagination uses different aria-labels
  ...
  it('renders ellipsis for large page counts', () => {
    ...
    // MUI uses ellipsis elements
    const ellipses = document.querySelectorAll('.MuiPaginationItem-ellipsis');
  ...
  it('applies custom className', () => {
    ...
    // MUI Pagination wraps in a nav element
  ...
  it('has proper aria-label for navigation', () => {
    ...
    // MUI Pagination renders a nav, and there's a wrapper Stack also as nav
    // Find the MuiPagination nav element specifically
    const navs = screen.getAllByRole('navigation');
    const paginationNav = navs.find((nav) =>
      nav.classList.contains('MuiPagination-root'),
    );
