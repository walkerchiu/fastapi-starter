...
describe('Radio', () => {
  ...
  it('renders description when provided', () => {
    render(
      <Radio
        label="SMS"
        description="You will receive notifications via email"
      />,
    );
    expect(
  ...
  it('sets aria-describedby for description', () => {
    render(<Radio id="test-radio" label="Test" description="Description" />);
...
describe('RadioGroup', () => {
  ...
  it('checks the radio matching the value prop', () => {
    ...
    // Option 2 is the second radio (index 1)
