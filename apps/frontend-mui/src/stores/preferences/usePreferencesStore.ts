 ...
 * Useful for storing user-specific settings that should persist across sessions.
 *
 * @example
 * ```tsx
 ...
 *   const { preferences, setPreference, toggleCompactMode } = usePreferencesStore();
 *
 *   return (
 *     <div>
 *       <label>
 ...
 *         onChange={(e) => setPreference('defaultPageSize', Number(e.target.value))}
 *       >
