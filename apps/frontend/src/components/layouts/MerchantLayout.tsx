...
const merchantNavItems: SidebarNavItem[] = [
  {
    key: 'dashboard',
    label: 'Dashboard',
    icon: <DashboardIcon />,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: 'Shipping',
        href: '/merchant/settings/shipping',
      },
      {
...
export function MerchantLayout({ children }: MerchantLayoutProps) {
  ...
  const getActiveKey = () => {
    ...
    if (pathname.includes('/merchant/orders')) return 'orders';
    if (pathname.includes('/merchant/inventory')) return 'inventory';
    if (pathname.includes('/merchant/customers')) return 'customers';
    if (pathname.includes('/merchant/settlements')) return 'settlements';
    if (pathname.includes('/merchant/analytics')) return 'analytics';
    if (pathname.includes('/merchant/settings/profile'))
      return 'settings-profile';
    if (pathname.includes('/merchant/settings/shipping'))
      return 'settings-shipping';
    if (pathname.includes('/merchant/settings/notifications'))
